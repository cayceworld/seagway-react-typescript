              ...
              <div className={styles.SelectedProduct__content}>
                <div className={styles.SelectedProduct__stock}>
                  {kickscooter.inStock > 0 ? (
                    <div className={styles.SelectedProduct__inStock}>
                      In stock
                    </div>
                  ) : (
                    <div className={styles.SelectedProduct__outStock}>
                      Out of stock
                    </div>
                  )}
                </div>
                    ...
                    <div>
                      <NavLink to="/cart">
                        <button
                          className={clsx(
                            styles.btn,
                            kickscooter.inStock <= 0 && styles.btn_disabled
                          )}
                          onClick={addProduct}
                          disabled={kickscooter.inStock <= 0 ? true : false}
                        >
                          buy it now
                        </button>
                      </NavLink>
                ...
                <div className={styles.SelectedProduct__payment}>
                  <p className={styles.SelectedProduct__text}>
                    <span>Payment Methods: </span>Starting at $55/mo with{" "}
                    <span>
                      {" "}
                      <img src={`${process.env.PUBLIC_URL}/images/logoA.svg`} />
                    </span>
                    . <span>Prequalify now</span>
                  </p>
                  <div className={styles.SelectedProduct__icons}>
                    <img
                      src={`${process.env.PUBLIC_URL}/images/Payment Ico/Frame (2).svg `}
                    />
                    <img
                      src={`${process.env.PUBLIC_URL}/images/Payment Ico/Frame (3).svg `}
                    />
                    <img
                      src={`${process.env.PUBLIC_URL}/images/Payment Ico/Frame (4).svg `}
                    />
                    <img
                      src={`${process.env.PUBLIC_URL}/images/Payment Ico/Frame (1).svg `}
                    />
                    <img
                      src={`${process.env.PUBLIC_URL}/images/Payment Ico/Frame (5).svg `}
                    />
                    <img
                      src={`${process.env.PUBLIC_URL}/images/Payment Ico/Frame (6).svg `}
                    />
                    <img
                      src={`${process.env.PUBLIC_URL}/images/Payment Ico/Frame (7).svg `}
                    />
                    <img
                      src={`${process.env.PUBLIC_URL}/images/Payment Ico/Frame (8).svg `}
                    />
                    <img
                      src={`${process.env.PUBLIC_URL}/images/Payment Ico/Frame (9).svg `}
                    />
                    <img
                      src={`${process.env.PUBLIC_URL}/images/Payment Ico/Frame (10).svg `}
                    />
                    <img
                      src={`${process.env.PUBLIC_URL}/images/Payment Ico/Frame (11).svg `}
                    />
                    <img
                      src={`${process.env.PUBLIC_URL}/images/Payment Ico/Frame (12).svg `}
                    />
                    <img
                      src={`${process.env.PUBLIC_URL}/images/Payment Ico/Frame (13).svg `}
                    />
                    <img
                      src={`${process.env.PUBLIC_URL}/images/Payment Ico/Frame (14).svg `}
                    />
                    <img
                      src={`${process.env.PUBLIC_URL}/images/Payment Ico/Frame (15).svg `}
                    />
                  </div>
                </div>
              </div>

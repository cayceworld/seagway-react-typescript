  ...
  return (
    <div className={styles.Accessory}>
      <div className={styles.Accessory__image}>
        <img
          src={`${process.env.PUBLIC_URL}/images/Accessories/${accessory.image}`}
        />
      </div>
      <div className={styles.Accessory__title}>{accessory.title}</div>
      <div className={styles.Accessory__description}>
      ...
      <div className={styles.Accessory__button}>
        <button
          onClick={addProduct}
          disabled={accessory.inStock <= 0 ? true : false}
          className={clsx(
            styles.btn,
            accessory.inStock <= 0 && styles.btn_disabled
          )}
        >
          add to card
        </button>

...
const Gift = props => {
  ...
  const gift = useSelector(state => getGiftAccessoryByKickscooter(state, props.gift));
  ...
  return (
    <div className={styles.gift__wrapper}>
      <div className={styles.gift__content}>
        ...
        <div className={styles.gift__subtitle}>
          {gift.description}
        </div>
      </div>
      <div className={styles.gift__image}>

        <img src={`${process.env.PUBLIC_URL}/images/Accessories/${gift.image}`} />

  ...
  return (
    <ul className={styles.navicons}>
      <li className={styles.navicons__item}>
        <a href="tel:1 (888) 888-88-88" className={styles.navicons__phone}>
          +1 (888) 888-88-88
        </a>
        <a href="tel:1 (888) 888-88-88">
          <img
            className={clsx(styles.navicons__img, styles.navicons__img_phone)}
      ...
      <li className={clsx(styles.navicons__item, styles.navicons__cartIco)}>
        ...
        {cart.length > 0 && (
          <div className={styles.navicons__cartQuantity}>
            {" "}
            {cartItemsAmount}{" "}
          </div>
        )}

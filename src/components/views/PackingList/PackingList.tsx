...
const PackingList = props => {
  ...
  return (
    <div className={styles.PackingList}>
      {!kickscooter.youtubeVideo && <h1 className={styles.PackingList__title}>Packing List</h1>}
      <div className={clsx(styles.PackingList__wrapper, !kickscooter.youtubeVideo && styles.PackingList__wrapper_noVideo)}>
        ...
        <div className={styles.PackingList__image}>
          <div>
            <img src={`${process.env.PUBLIC_URL}/images/Packing List/${kickscooter.packingList}`} />
          </div>
        </div>
      </div>
    </div>
